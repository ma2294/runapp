...
public class StepsModel {
    ...
    private int dailyStepsGoal = 25000; //TODO add contextualised step goals- must store in db.. or start at 5000, 7500 and 10000 based on user type and then accomodate based on previous day performance. If reached +10% if not -10%.
